        ...
        <section id={'Welcome'} className={'h-screen w-screen bg-slate-300/20 overflow-hidden relative z-10'}>
            <Container className={'flex-center flex-col py-12'}>
                ...
                <h2 className={'w-full lg:w-1/2 text-slate-800 text-4xl md:text-6xl text-center font-bold px-12 '}>
                    Crafting <span
                    className={' px-2 py-1 border-l-2 border-indigo-500 bg-gradient-to-r from-indigo-500'}>Next-Gen</span> Web
                    Experiences
                </h2>
                ...
                <Image src={'/assets/welcomeMedium.png'} alt={'Welcome Image'} width={1200} height={800}
                       className={'w-full -mt-32 hidden md:block lg:hidden scale-125'}/>
                <Image src={'/assets/welcomeSmall.png'} alt={'Welcome Image'} width={1200} height={800}
                       className={'w-full -mt-20 block md:hidden'}/>
            </Container>
        </section>
    )
}
